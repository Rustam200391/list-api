#Task:</br>
1.инициаизировать react app (выбрать шаблон с typescript or reactquery)</br>
2.react-router присоединяем </br>
...
<iдля маршрутизации используем только react-router </br>
5. не использовать redux </br>
6. Используя библиотеку react query подключить api смотреть видео для query typescript и react-router.</br>
