...
4.@ts-ignore убираем ошибку тайпскрипт 
для маршрутизации используем только react-router 
5. не использовать redux 
6. Используя библиотеку react query подключить api смотреть видео для query typescript и react-router.
